...
const translations = {
  en: {
    ...
    'footer.address': 'Mongolian Grand Theatre of National Arts SBD - 1 khoroo, Ulaanbaatar Mongolia',
  ...
  mn: {
    ...
    'footer.address': 'Үндэсний Урлагийн Их Театр, СБД-1 хороо, Улаанбаатар, Монгол',
    'footer.phone': '+976 8901 1333, +976 9800 9944',
    'footer.email': 'sevjiddancesevjid@gmail.com',
